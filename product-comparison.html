...
<head>
	...
	<link rel="stylesheet" href="assets\css\do.css">
			...
			<div class="table-responsive">
				<table class="table compare-table inner-top-vs">
					<tr>
						<th>
							<ul>
								<li class="active">Tất cả tính năng</li>
								<li class="active">Tính năng tương tự</li>
								<li class="active" style="color: #ff2d2b;">Tính năng khác nhau</li>
							</ul>
						</th>
						<td>
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail.html">
										    <img alt="" src="assets\images\products\p8.jpg">
										</a>
									</div>
									<div class="product-info text-left">
										<h3 class="name"><a href="detail.html">Samsung Galaxy A04s (4+64GB)</a></h3>
										<div class="product-price">
											<span class="price">3.190.000 đ</span>
											<span class="price-before-discount">3.890.000 đ</span>
										</div>
										<div class="action">
										    <a class="lnk btn btn-primary" href="#" style="background-color: #ff2d2b;">Mua ngay</a>
											<a class="lnk btn btn-primary" href="#"><i class="icon fa fa-shopping-cart"></i></a>
										</div>
										<div class="star">
											<i class="fa-solid fa-star"></i>
											<span class="text">Đánh giá: 5/5</span> 
										</div>
									</div>
								</div>
							</div>
						...
						<td>
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail.html">
										    <img alt="" src="assets\images\products\spcg4.png">
										</a>
									</div>

									<div class="product-info text-left">
										<h3 class="name"><a href="detail.html">Điện thoại Samsung Galaxy A14 4G (4+128GB)</a></h3>
										<div class="product-price">
											<span class="price">3.190.000 đ</span>
											<span class="price-before-discount">3.890.000 đ</span>
										</div>
					...
					<tr>
						<th>Chipset</th>
						<td>Exynos 850 (8nm)</td>
						<td>Exynos 850 8 nhân</td>
					</tr>
					<tr>
						<th>Loại màn hình</th>
						<td>IPS LCD</td>
					...
					<tr>
						<th>Mở khóa nhanh</th>
						<td>Mở khoá vân tay cạnh viền, Mở khoá khuôn mặt</td>
